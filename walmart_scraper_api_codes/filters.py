"""
Walmart Filters - Chocodata Walmart Scraper API
...
Runnable example. It calls the LIVE API and prints the real JSON response.
    ...
    python walmart_scraper_api_codes/filters.py
...
API = "https://api.chocodata.com/api/v1/walmart/filters"
...
def filters(query: str) -> dict:
    """Available search facets (RAM, brand, price ...) and sort options for a query."""
...
if __name__ == "__main__":
    ...
    print(f"{len(names)} filter groups: {names[:6]}")
